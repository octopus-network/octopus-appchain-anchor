...
export NEAR_ENV=$1
#
near view $2 get_anchor_version ''
near view $2 get_owner ''
near view $2 get_owner_pk ''
...
near view $2 get_wrapped_appchain_nfts ''
...
near view $2 get_staking_histories '{"start_index":"0"}'
near view $2 get_appchain_notification_histories '{"start_index":"0"}'
near view $2 get_validator_list_of '{"era_number":null}'
near view $2 get_appchain_messages '{"start_nonce":0}'
near view $2 get_appchain_message_processing_results '{"start_nonce":0}'
near view $2 get_appchain_challenge ''
