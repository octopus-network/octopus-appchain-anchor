...
* `previous_appchain_anchor.wasm` - The last version of this contract, depends on the current version. This is for migration testing. For example, to `v2.1.0`, this file should be the wasm of `v2.0.0`.
