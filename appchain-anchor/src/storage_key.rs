...
pub enum StorageKey {
    ...
    BeefyAuthoritySetHistories,
    BeefyCommitmentHistories,
    ValidatorProfiles,
...
impl StorageKey {
    pub fn to_string(&self) -> String {
        match self {
            ...
            StorageKey::BeefyAuthoritySetHistories => "bash".to_string(),
            StorageKey::BeefyCommitmentHistories => "bch".to_string(),
