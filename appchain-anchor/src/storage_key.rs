...
pub enum StorageKey {
    ...
    BeefyLightClientValidatorProofsLeafSet,
    BeefyLightClientValidatorProofsMap,
    LightClientStateCommitmentInProcessing,
    ValidatorProfiles,
...
impl StorageKey {
    pub fn to_string(&self) -> String {
        match self {
            ...
            StorageKey::BeefyLightClientValidatorProofsLeafSet => "blcvpls".to_string(),
            StorageKey::BeefyLightClientValidatorProofsMap => "blcvpm".to_string(),
            StorageKey::LightClientStateCommitmentInProcessing => "lcscip".to_string(),
